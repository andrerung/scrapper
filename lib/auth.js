...
import { logger, saveJsonFile, loadJsonFile, delay, promptConfirmation } from './utils.js';
...
export class AuthManager {
  ...
  async authenticate() {
    ...
    // Launch with arguments that make the browser appear more like a regular user browser
    // Note: These flags help Google recognize this as a legitimate browser session
